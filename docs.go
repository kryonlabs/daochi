			...
			"schemas": map[string]any{
				...
				"SyncResponse": map[string]any{
					...
					"properties": map[string]any{
						...
						"latest_protocol":                       map[string]any{"type": "integer", "description": "Negotiated protocol for legacy clients; not an app release indicator."},
						"server_latest_protocol":                map[string]any{"type": "integer", "description": "Newest server protocol capability; not an app release indicator."},
